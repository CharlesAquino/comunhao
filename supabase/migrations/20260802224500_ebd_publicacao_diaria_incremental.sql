...
begin
  ...
  insert into public.admin_audit_log (
    ...
    jsonb_build_object('status', v_lesson.status, 'version', v_lesson.versao, 'day_id', p_day_id),
    jsonb_build_object('status', 'published', 'version', v_new_version, 'day_id', p_day_id),
    trim(p_reason)
  );
