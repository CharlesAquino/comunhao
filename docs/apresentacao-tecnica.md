...
> Registro histórico. OTP de cadastro, `VerifyOtp.tsx` e WhatsApp administrativo
> não representam mais o estado atual do produto.
...
> `SESSAO_2026-08-10_REGISTRO_COMPLETO.md`. A release development vigente é
